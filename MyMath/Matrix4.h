...
public:
    ...
    // 设置四个行向量。
    void setRows(const Vector4& first, const Vector4& second, const Vector4& third, const Vector4& fourth);

    // 设置四个列向量。
    void setColumns(const Vector4& first, const Vector4& second, const Vector4& third, const Vector4& fourth);
    ...
    bool operator==(const Matrix4& other) const{return isEqualTo(other);}
    bool operator!=(const Matrix4& other) const{return !isEqualTo(other);}
